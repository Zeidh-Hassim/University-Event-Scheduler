...
<div class="vh-full">
    <div class="container">
        <div class="text-center mb-3 text-white">
            <h1>Welcome to University of Vavuniya Event Schedule System</h1>
            <p>Faculty-level events/activities organized by the approved student Societies</p>
        </div>
        ...
        <div class="row justify-content-center g-1">
            ...
            <div class="card shadow-sm col-md-5 m-2" style="opacity: 0.95;">
                ...
                <div class="card-body">
                    <form action="{{ route('scheduleSocietyEvent') }}" method="POST" enctype="multipart/form-data">
                        @csrf
